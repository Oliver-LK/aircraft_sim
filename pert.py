...
from simulation_setup import init_atmos_data, init_x0_for_perturbation, give_perturbation_sim_time
...
# Simulation times
t0_s = 0        # Start time
tf_s =  give_perturbation_sim_time()
h_s = 0.1       # Time step
